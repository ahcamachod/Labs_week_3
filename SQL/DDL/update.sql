...
--CREATE TABLE cars (id SMALLINT, vin TEXT, manufacturer VARCHAR(15), model VARCHAR(17), year SMALLINT, color VARCHAR(10));
--CREATE TABLE customers (id SMALLINT, customer_id TEXT, name TEXT, phone TEXT, email TEXT, address TEXT, city TEXT, state_province TEXT, country TEXT, zip_code INTEGER);
--CREATE TABLE salespersons (id SMALLINT, staff_id SMALLINT, name TEXT, store TEXT);
--CREATE TABLE invoices (id SMALLINT, inv_number BIGINT, date TEXT, car SMALLINT, customer SMALLINT, sales_person SMALLINT); 
--INSERT INTO cars VALUES (0,'3K096I98581DHSNUP', 'Volkswagen', 'Tiguan', 2019, 'Blue');
--INSERT INTO cars VALUES (1,'RKXVNNIHLVVZOUB4M', 'Peugeot', 'Rifter', 2019, 'Red');
--INSERT INTO cars VALUES (2,'ZM8G7BEUQZ97IH46V', 'Ford', 'Fusion', 2018, 'White');
